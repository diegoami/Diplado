  ...
  (
	...
	#toggle lord recycling
	  ...
	  ("dplmc_toggle_holdground_entering_battle_b",[
		...
		],"Disable hold ground entering battle",
       [
	 	   (assign, "$g_dplmc_holdground_entering_battle", DPLMC_HOLDGROUND_ENTERING_BATTLE_DISABLE),
        ]),
      ("dplmc_toggle_lord_recycling_reset",
		[(neq, "$g_dplmc_lord_recycling", DPLMC_HOLDGROUND_ENTERING_BATTLE_ENABLE),
 		 (neq, "$g_dplmc_lord_recycling", DPLMC_HOLDGROUND_ENTERING_BATTLE_DISABLE),
